                                ...
                                <div class="box px-0">
                                    <div class="item item-size-3-2">
                                        <div class="card p-0 hover-change-image">
                                            <a href="{{ asset('assets/images/' . $image->filename) }}" class="card-img"
                                                data-gtf-mfp="true" data-gallery-id="04"
                            ...
                            <div class="slick-slider slider-nav-01 mt-4 mx-n1 arrow-haft-inner"
                                ...
                                <div class="box pb-6 px-0">
                                    <div class="bg-hover-white p-1 shadow-hover-xs-3 h-100 rounded-lg">
                                        <img src="{{ asset('assets/images/' . $image->filename) }}" alt="Gallery 01"
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h5 class="my-1 fs-14 text-uppercase letter-spacing-093 font-weight-normal">
                                            Diện tích</h5>
                                        <p class="mb-0 fs-13 font-weight-bold text-heading">{{$rooms->acreage ?? '200'}}</p>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="col-lg-3 col-sm-4 mb-6">
                            ...
                            <div class="col-lg-3 col-sm-4 mb-6">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h5 class="my-1 fs-14 text-uppercase letter-spacing-093 font-weight-normal">
                                            GARAGE</h5>
                                        <p class="mb-0 fs-13 font-weight-bold text-heading">{{$utilities->garage ?? '1'}}</p>
                                    </div>
                                </div>
                            </div>
...
@endif
    WiFi
                            ...
                            <li class="col-sm-3 col-6 mb-2"> @if($utilities && $utilities->air_conditioning == 1) 
        <i class="far fa-check mr-2 text-primary"></i> 
    @endif
    Máy điều hòa
                            </li>
                            <li class="col-sm-3 col-6 mb-2"> @if($utilities && $utilities->garage == 1) 
        <i class="far fa-check mr-2 text-primary"></i> 
    @endif
    Garage
                            </li>
                                        ...
                                        <div class="bg-gray-01 rounded-lg pt-2 px-6 pb-6">
                                            ...
                                            <ul class="list-inline">
                                                @for ($i = 1; $i <= 5; $i++) <li
                                                    ...
                                                    @if ($i <= floor($averageRating)) <i
                                                        class="fas fa-star text-warning"></i>
                                                        @elseif ($i == ceil($averageRating) && $averageRating -
                                        ...
                                        <div class="row mb-1 align-items-center">
                                            ...
                                            <div class="col-sm-6">
                                                <ul
                                                    ...
                                                    @for ($i = 1; $i <= 5; $i++) <li class="list-inline-item mr-1">
                                ...
                                <form id="commentForm" action="{{ route('client.danh-gia') }}" method="POST">
                                    ...
                                    <div class="form-group mb-6">
                                        <textarea class="form-control form-control-lg border-0"
                                            placeholder="Đánh giá của bạn" name="content" rows="5"></textarea>
                                    </div>
                    ...
                    <section class="mt-2 pb-6 px-6 pt-6 bg-white rounded-lg">
                        ...
                        <p
                                    class="mb-0 p-3 bg-white shadow rounded-lg">
                                    {{ $rooms->address }}</p>
                        <div class="position-relative">
                            <div class="position-relative">
                ...
                @endif
                                    ...
                                    <div class="card-body pt-3">
                                        <h2 class="card-title fs-16 lh-2 mb-0"><a href="{{ route('client.detail-room', ['slug' => $similarRoom->slug]) }}"
                                                class="text-dark hover-primary">{{$similarRoom->title}}</a></h2>
                                        <p class="card-text font-weight-500 text-gray-light mb-2">{{$similarRoom->address}}</p>
                                        <ul class="list-inline d-flex mb-0 flex-wrap mr-n4">
                                            ...
                                            <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-4"
                                                ...
                                                </svg>{{$similarRoom->utility->bathroom ?? '0'}}
                                            </li>
                                            <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-4"
                                                data-toggle="tooltip" title="Size">
                                                <svg class="icon icon-square fs-18 text-primary mr-1">
                                                    <use xlink:href="#icon-square"></use>
                                                </svg>{{$similarRoom->acreage}}m
                                            </li>
                                            <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-4"
                                                data-toggle="tooltip" title="1 Garage">
                                                <svg class="icon icon-Garage fs-18 text-primary mr-1">
                                                    <use xlink:href="#icon-Garage"></use>
                                                </svg>{{$similarRoom->utility->garage ?? '0'}}
                                            </li>
                                        </ul>
                                    </div>
                                    <div
                                        class="card-footer bg-transparent d-flex justify-content-between align-items-center py-3">
                                        <p class="fs-17 font-weight-bold text-heading mb-0">   {{ number_format($similarRoom->price, 0, ',', '.') }} VND</p>
                                        <ul class="list-inline mb-0">
                                            <li class="list-inline-item mr-2">
                                                <a href="{{ route('client.add.favourite', ['slug' => $similarRoom->slug]) }}"
                                                    class="w-40px h-40 border rounded-circle d-inline-flex align-items-center justify-content-center">
                                                    <i class="fas fa-heart"></i>
                                                </a>
                                            </li>
            ...
            <div class="modal-body p-4 py-sm-7 px-sm-8 text-center">
                ...
                <form id="reportForm" method="POST" action="{{ route('client.report-store-room') }}">
                    ...
                    <div class="form-group mb-4">
                        <textarea class="form-control border-0 " placeholder="Nội dung báo cáo..." name="description"
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyC67NQzqFC2WplLzC_3PsL5gejG1_PZLDk&libraries=places">
    </script>
    <script src="{{ asset('assets/js/set-mapclient.js') }}"></script>
    <script>
    document.addEventListener('DOMContentLoaded', function () {
        // Lấy kinh độ và vĩ độ được truyền từ backend
        var latitude = {{ $rooms->latitude }};
        var longitude = {{ $rooms->longitude }};
        var roomName = "{{ $rooms->title }}"; // Tên của room

        // Gọi hàm initMap từ file map.js
        initMap(latitude, longitude, roomName);
    });
</script>
@endpush