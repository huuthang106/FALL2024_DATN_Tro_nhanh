    ...
    <main id="content">
        ...
        <section class="pt-13 pb-12">
            ...
            '>
                        ...
                        <div class="media mb-6 pb-5 border-bottom">
                            ...
                            <div class="media-body">
                                ...
                                <ul class="list-inline">
                                    ...
                                    <li class="list-inline-item"><a href="#" class="text-heading hover-primary">Trả
                                            lời</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="media mb-6 pb-5 border-bottom">
                            <div class="w-70px mr-2">
                                <img src="{{ asset('assets/images/review-05.jpg') }}" alt="Arhi">
                            </div>
                            <div class="media-body">
                                <p class="text-heading fs-16 font-weight-500 mb-0">Arhi</p>
                                <p class="mb-4">Trọ thoáng mát</p>
                                <ul class="list-inline">
                                    <li class="list-inline-item text-muted">02 Tháng 12 2019 lúc 2:40pm<span
                                            class="d-inline-block ml-2">|</span></li>
                                    <li class="list-inline-item"><a href="#" class="text-heading hover-primary">Trả
                        ...
                        <div class="media mb-10 pb-5 border-bottom">
                            ...
                            <div class="media-body">
                                <p class="text-heading fs-16 font-weight-500 mb-0">Malphite</p>
                                <p class="mb-4">Tôi cảm thấy nó thật tuyệt vời</p>
                                <ul class="list-inline">
                                    <li class="list-inline-item text-muted">02 Tháng 12 2019 lúc 2:40pm<span
                                            class="d-inline-block ml-2">|</span></li>
                                    <li class="list-inline-item"><a href="#" class="text-heading hover-primary">Trả
