...
<main id="content" class="bg-gray-01">
  ...
  <!-- Vendors CSS -->
  <link rel="stylesheet" href="{{ asset('asset/vendors/fontawesome-pro-5/css/all.css') }}">
  <link rel="stylesheet" href="{{ asset('asset/vendors/bootstrap-select/css/bootstrap-select.min.css') }}">
  <link rel="stylesheet" href="{{ asset('asset/vendors/slick/slick.min.css') }}">
  <link rel="stylesheet" href="{{ asset('asset/vendors/magnific-popup/magnific-popup.min.css') }}">
  <link rel="stylesheet" href="{{ asset('asset/vendors/jquery-ui/jquery-ui.min.css') }}">
  <link rel="stylesheet" href="{{ asset('asset/vendors/chartjs/Chart.min.css') }}">
  <link rel="stylesheet" href="{{ asset('asset/vendors/dropzone/css/dropzone.min.css') }}">
  <link rel="stylesheet" href="{{ asset('asset/vendors/animate.css') }}">
  <link rel="stylesheet" href="{{ asset('asset/vendors/timepicker/bootstrap-timepicker.min.css') }}">
  <link rel="stylesheet" href="{{ asset('asset/vendors/mapbox-gl/mapbox-gl.min.css') }}">
  <link rel="stylesheet" href="{{ asset('asset/vendors/dataTables/jquery.dataTables.min.css') }}">
  <!-- Themes core CSS -->
  <link rel="stylesheet" href="{{ asset('asset/css/themes.css') }}">
  <!-- Favicons -->
  ...
  <meta property="og:image" content="{{ asset('asset/images/homeid-social.png') }}">
...
<script src="{{ asset('asset/vendors/jquery-ui/jquery-ui.min.js') }}"></script>
<script src="{{ asset('asset/vendors/bootstrap/bootstrap.bundle.js') }}"></script>
<script src="{{ asset('asset/vendors/bootstrap-select/js/bootstrap-select.min.js') }}"></script>
<script src="{{ asset('asset/vendors/slick/slick.min.js') }}"></script>
<script src="{{ asset('asset/vendors/waypoints/jquery.waypoints.min.js') }}"></script>
<script src="{{ asset('asset/vendors/counter/countUp.js') }}"></script>
...
<script src="{{ asset('asset/vendors/dropzone/js/dropzone.min.js') }}"></script>
<script src="{{ asset('asset/vendors/timepicker/bootstrap-timepicker.min.js') }}"></script>
<script src="{{ asset('asset/vendors/hc-sticky/hc-sticky.min.js') }}"></script>
<script src="{{ asset('asset/vendors/jparallax/TweenMax.min.js') }}"></script>
<script src="{{ asset('asset/vendors/mapbox-gl/mapbox-gl.js') }}"></script>
<script src="{{ asset('asset/vendors/dataTables/jquery.dataTables.min.js') }}"></script>
<!-- Theme scripts -->
