                        ...
                        <div class="row align-items-sm-center mb-6">
                            <div class="col-md-6 col-xl-5 col-xxl-6">
                                <h2 class="fs-15 text-dark mb-0">Chúng tôi đã tìm thấy <span
                                        class="text-primary">45</span> phòng trọ dành cho bạn
                                </h2>
                            </div>
                            ...
                            <div class="col-12">
                                    ...
                                    <div class="row no-gutters">
                                                ...
                                                <div class="card-img-overlay p-2 d-flex flex-column">
                                                    ...
                                                    <div class="mt-auto d-flex hover-image">
                                                        ...
                                                        <ul class="list-inline mb-0 d-flex align-items-end mr-n3">
                                                            ...
                                                            <li class="list-inline-item h-32  mr-3" data-toggle="tooltip"
                                                                title="So sánh">
                                                                <a href="#" class="text-white fs-20 hover-primary">
                                        ...
                                        <div class="col-md-6 ">
                                            <div class="card-body p-0">
                                                <h2 class="card-title my-0"><a href="single-property-1.html"
                                                        class="fs-16 lh-2 text-dark hover-primary d-block">Home in Metric
                                                        Way</a>
                                                </h2>
                                                <p class="card-text mb-1 font-weight-500 text-gray-light">Ninh Kiều, TP.Cần
                                                    Thơ</p>
                                                <p class="card-text mb-2 ml-0">Phòng trọ sạch sẽ, thoáng mát, gần trung
                                                    tâm, thuận tiện đi lại. Đầy đủ tiện nghi cơ bản như điều hòa, giường,
                                                    tủ. An ninh đảm bảo, có bảo vệ 24/7. Phù hợp với sinh viên và người đi
                                                    làm.
                                                </p>
                                ...
                                <div class="card mb-8 mb-lg-6 border-0" data-animate="fadeInUp">
                                    <div class="row no-gutters">
                                        <div class="col-md-6 mb-5 mb-md-0 pr-md-6">
                                            <div class="position-relative hover-change-image bg-hover-overlay h-100 pt-75 bg-img-cover-center rounded-lg"
                                                style="background-image: url('{{ asset('assets/images/properties-list-16.jpg') }}');">
                                                <div class="card-img-overlay p-2 d-flex flex-column">
                                                    <div>
                                                        <span class="badge badge-primary">Cần bán</span>
                                                    </div>
                                ...
                                <div class="card mb-8 mb-lg-6 border-0" data-animate="fadeInUp">
                                    <div class="row no-gutters">
                                        <div class="col-md-6 mb-5 mb-md-0 pr-md-6">
                                            <div class="position-relative hover-change-image bg-hover-overlay h-100 pt-75 bg-img-cover-center rounded-lg"
                                                style="background-image: url('{{ asset('assets/images/properties-list-05.jpg') }}');">
                                                <div class="card-img-overlay p-2 d-flex flex-column">
                                                    <div>
                                                        <span class="badge badge-primary">Cần bán</span>
                                                    </div>
                                ...
                                <div class="card mb-8 mb-lg-6 border-0" data-animate="fadeInUp">
                                    <div class="row no-gutters">
                                        <div class="col-md-6 mb-5 mb-md-0 pr-md-6">
                                            <div class="position-relative hover-change-image bg-hover-overlay h-100 pt-75 bg-img-cover-center rounded-lg"
                                                style="background-image: url('{{ asset('assets/images/properties-list-17.jpg') }}');">
                                                <div class="card-img-overlay p-2 d-flex flex-column">
                                                    <div>
                                                        <span class="badge badge-primary">Cần bán</span>
                                                    </div>
                                ...
                                <div class="card mb-8 mb-lg-6 border-0" data-animate="fadeInUp">
                                    <div class="row no-gutters">
                                        <div class="col-md-6 mb-5 mb-md-0 pr-md-6">
                                            <div class="position-relative hover-change-image bg-hover-overlay h-100 pt-75 bg-img-cover-center rounded-lg"
                                                style="background-image: url('{{ asset('assets/images/properties-list-18.jpg') }}');">
                                                <div class="card-img-overlay p-2 d-flex flex-column">
                                                    <div>
                                                        <span class="badge badge-primary">Cần bán</span>
                                                    </div>
                                ...
                                <div class="card mb-8 mb-lg-6 border-0" data-animate="fadeInUp">
                                    <div class="row no-gutters">
                                        <div class="col-md-6 mb-5 mb-md-0 pr-md-6">
                                            <div class="position-relative hover-change-image bg-hover-overlay h-100 pt-75 bg-img-cover-center rounded-lg"
                                                style="background-image: url('{{ asset('assets/images/properties-list-19.jpg') }}');">
                                                <div class="card-img-overlay p-2 d-flex flex-column">
                                                    <div>
                                                        <span class="badge badge-primary">Cần bán</span>
                                                    </div>
                                        ...
                                        <div class="col-md-6 ">
                                            <div class="card-body p-0">
                                                ...
                                                <p class="card-text mb-1 font-weight-500 text-gray-light">Ninh Kiều,
                                                    TP.Cần
                                                    Thơ</p>
                                                <p class="card-text mb-2 ml-0">Phòng trọ sạch sẽ, thoáng mát, gần trung
                                                    tâm, thuận tiện đi lại. Đầy đủ tiện nghi cơ bản như điều hòa, giường,
                                ...
                                <div class="card mb-8 mb-lg-6 border-0" data-animate="fadeInUp">
                                    <div class="row no-gutters">
                                        <div class="col-md-6 mb-5 mb-md-0 pr-md-6">
                                            <div class="position-relative hover-change-image bg-hover-overlay h-100 pt-75 bg-img-cover-center rounded-lg"
                                                style="background-image: url('{{ asset('assets/images/properties-list-20.jpg') }}');">
                                                <div class="card-img-overlay p-2 d-flex flex-column">
                                                    <div>
                                                        <span class="badge badge-primary">Cần bán</span>
                                                    </div>
