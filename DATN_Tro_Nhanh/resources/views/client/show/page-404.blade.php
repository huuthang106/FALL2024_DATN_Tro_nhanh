            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-2 mb-6 mb-md-0">
                    ...
                    <ul class="list-group list-group-flush list-group-no-border">
                        ...
                        <li class="list-group-item bg-transparent p-0">
                            <a href="#" class="text-muted lh-26 font-weight-500 hover-white">Offices for
                                Rent</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-6 mb-6">
                        ...
                        <ul class="list-unstyled row">
                            ...
                            <li class="col-md-6 lh-26">
                                <a href="single-property-1.html" class="text-body hover-dark">
                                    Nhà Cao Cấp tại Đà Nẵng
                                </a>
                            </li>
                            <li class="col-md-6 lh-26">
                                <a href="single-property-1.html" class="text-body hover-dark">
                                    Biệt Thự cho Thuê tại Hội An
                                </a>
                            </li>
                            <li class="col-md-6 lh-26">
                                <a href="single-property-1.html" class="text-body hover-dark">
                            ...
                            <li class="col-md-6 lh-26">
                                <a href="single-property-1.html" class="text-body hover-dark">
                                    Biệt Thự cho Thuê tại Đà Nẵng
                                </a>
                            </li>
                            <li class="col-md-6 lh-26">
                                <a href="single-property-1.html" class="text-body hover-dark">
                                    Nhà Cao Cấp tại Hồ Chí Minh
                                </a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-6 mb-6">
                        <h2 class="fs-22 lh-15 text-dark border-bottom pb-2 mb-2">Bài Viết Mới Nhất</h2>
                        <ul class="list-unstyled row">
                            <li class="col-md-6 lh-26">
                                <a href="blog-details-1.html" class="text-body hover-dark">
                                    Tiện ích tìm kiếm bên phải
                                </a>
                            </li>
                            <li class="col-md-6 lh-26">
                                <a href="blog-details-1.html" class="text-body hover-dark">
                            ...
                            <li class="col-md-6 lh-26">
                                <a href="blog-details-1.html" class="text-body hover-dark">
                                    Bài Viết Toàn Màn Hình
                                </a>
                            </li>
                            <li class="col-md-6 lh-26">
                                <a href="blog-details-1.html" class="text-body hover-dark">
                                    Văn Phòng tại San Francisco
                                </a>
                            </li>
                            <li class="col-md-6 lh-26">
                                <a href="blog-details-1.html" class="text-body hover-dark">
                                    Thanh Sidebar ở Bên Trái
                                </a>
                            </li>
                        </ul>
                    </div>
