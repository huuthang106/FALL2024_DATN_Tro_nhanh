                      ...
                      <div class="card-body px-8 py-6">
                          ...
                          <form class="form">
                              <div class="form-group mb-4">
                                  ...
                                  <input type="text" class="form-control form-control-lg border-0" id="username-1" name="username" placeholder="Email của bạn">
                              </div>
                              <div class="form-group mb-4">
                                  <label for="password-2">Mật khẩu</label>
                                  <div class="input-group input-group-lg">
                                      <input type="text" class="form-control border-0 shadow-none fs-13" id="password-2" name="password" placeholder="Mật khẩu">
                              ...
                              <button type="submit" class="btn btn-primary btn-lg btn-block rounded">Đăng nhập</button>
                          </form>
