    ...
    @foreach ($rooms as $room)
        <div class="box pb-7 pt-2">
            <div class="card shadow-hover-2" data-animate="zoomIn">
                <div class="hover-change-image bg-hover-overlay rounded-lg card-img-top" style="height: 200px; overflow: hidden;">
                    @if ($room->images->isNotEmpty())
                        ...
                        <img src="{{ asset('assets/images/' . $image->filename) }}"
                             alt="{{ $room->title }}"
                             class="img-fluid w-100 h-100 rounded" style="object-fit: cover; height: 100%; width: 100%;">
                    @else
                ...
                <div class="card-body pt-3">
                    ...
                    <p class="card-text font-weight-500 text-gray-light mb-2">{{ $room->address }}</p>
