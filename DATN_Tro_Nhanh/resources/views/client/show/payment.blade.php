          ...
          <div class="row">
              <div class="col-lg-4 col-md-5 col-sm-8 mb-6 mb-md-0">
                  ...
                  <div class="card border-0">
                      <div class="card-header bg-transparent d-flex justify-content-between align-items-center px-0 pb-3">
                          <p class="fs-15 font-weight-bold text-heading mb-0 text-uppercase mr-2">Gói <span class="font-weight-500">Premium</span></p>
              ...
              <div class="col-md-7 offset-lg-1">
                  ...
                  <div class="custom-control custom-radio mb-2">
                      ...
                      <label for="card" class="font-weight-500 mb-0 custom-control-label"><span class="fs-12 text-heading d-inline-block mr-1"><i class="fas fa-credit-card"></i></span>Thanh Toán Bằng Thẻ Tín Dụng</label>
                  </div>
                  <div class="custom-control custom-radio mb-2">
                      <input type="radio" id="wire" name="pay" value="wire" class="custom-control-input">
                      <label for="wire" class="font-weight-500 mb-0 custom-control-label"><span class="text-heading fs-12  d-inline-block mr-1"><i class="fas fa-paper-plane"></i></span>Chuyển Khoản</label>
                  </div>
                  ...
                  <p class="mb-6">Vui lòng đọc <a href="#" class="text-heading font-weight-500 border-bottom hover-primary">Điều Khoản & Điều Kiện</a> trước</p>
