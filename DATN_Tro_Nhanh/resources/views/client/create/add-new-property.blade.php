                            ...
                            <ul class="nav nav-pills border py-2 px-3 mb-6 d-none d-md-flex mb-6" role="tablist">
                                <li class="nav-item col">
                                    <a class="nav-link active bg-transparent shadow-none py-2 font-weight-500 text-center lh-214 d-block"
                                        id="description-tab" data-toggle="pill" data-number="1." href="#description"
                                        role="tab" aria-controls="description" aria-selected="true"><span
                                            class="number">1.</span>Mô tả</a>
                                </li>
                                <li class="nav-item col">
                                ...
                                <li class="nav-item col">
                                    <a class="nav-link bg-transparent shadow-none py-2 font-weight-500 text-center lh-214 d-block"
                                        id="location-tab" data-toggle="pill" data-number="3." href="#location"
                                        role="tab" aria-controls="location" aria-selected="false"><span
                                            class="number">3.</span>Vị trí</a>
                                </li>
                                <li class="nav-item col">
                                    <a class="nav-link bg-transparent shadow-none py-2 font-weight-500 text-center lh-214 d-block"
                                ...
                                <li class="nav-item col">
                                    <a class="nav-link bg-transparent shadow-none py-2 font-weight-500 text-center lh-214 d-block"
                                        id="amenities-tab" data-toggle="pill" data-number="5." href="#amenities"
                                        role="tab" aria-controls="amenities" aria-selected="false"><span
                                            class="number">5.</span>Tiện nghi</a>
                                </li>
                            </ul>
                                                                ...
                                                                <div class="card mb-6">
                                                                    <div class="card-body p-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="title"
                                                                                class="text-heading">Tiêu đề<span
                                                                        ...
                                                                        <div class="form-group mb-0">
                                                                            <label for="description-01"
                                                                                class="text-heading">Sự miêu tả</label>
                                                                    ...
                                                                    <div class="card-body p-6">
                                                                        ...
                                                                        <div class="form-row mx-n2">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="form-group mb-0">
                                                                                    <label for="list-in"
                                                                                        class="text-heading">Được liệt kê
                                                                                        trong
                                                                                        in</label>
                                                                                    <select
                                                                                        class="form-control border-0 shadow-none form-control-lg selectpicker"
                                                            ...
                                                            <div class="col-lg-6">
                                                                    ...
                                                                    <div class="card-body p-6">
                                                                        ...
                                                                        <div class="form-row mx-n2">
                                                                            <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                                                                <div class="form-group">
                                                                                    <label for="fee"
                                                                                        class="text-heading">Phí Hiệp hội
                                                                                        chủ nhà<span
                                                                                            class="text-muted">(hàng
                                                                                            tháng)</span></label>
                                                                                    <input type="text"
                                                                                        class="form-control form-control-lg border-0"
                                                                                        id="fee" name="fee">
                                                                ...
                                                                <div class="card mb-6">
                                                                    <div class="card-body p-6">
                                                                        ...
                                                                        <div class="form-group mb-0">
                                                                            <label for="status"
                                                                                class="text-heading">Tình trạng tài
                                                                                sản</label>
                                                                            <select
                                                                                class="form-control border-0 shadow-none form-control-lg selectpicker"
                                                                                title="Select"
                                                ...
                                                <div class="card-header d-block d-md-none bg-transparent px-0 py-1 border-bottom-0"
                                                    ...
                                                    <h5 class="mb-0">
                                                        <button
                                                            ...
                                                            data-target="#media-collapse" aria-expanded="true"
                                                                    ...
                                                                    <div class="card-body p-6">
                                                                        ...
                                                                        <div class="dropzone upload-file text-center py-5"
                                                                            ...
                                                                            <div class="dz-default dz-message">
                                                                                <span
                                                                                    class="upload-icon lh-1 d-inline-block mb-4"><i
                                                                        ...
                                                                        <div class="form-row mx-n2">
                                                                            <div class="col-md-6 col-lg-12 col-xxl-6 px-2">
                                                                                <div class="form-group mb-md-0">
                                                                                    <label for="video-from"
                                                                                        class="text-heading">Video
                                                                                        từ</label>
                                                                                    <select
                                                                                        class="form-control border-0 shadow-none form-control-lg selectpicker"
                                                                                        data-style="btn-lg py-2 h-52"
                                                                    ...
                                                                    <div class="card-body p-6">
                                                                        ...
                                                                        <div class="form-group mb-0">
                                                                            <label for="virtual-tour"
                                                                                class="text-heading">Chuyến tham quan
                                                                                ảo</label>
                                                                            <input type="text"
                                                                                class="form-control form-control-lg border-0"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="card mb-6">
                                                                    <div class="card-body p-6">
                                                                        ...
                                                                        <div class="form-group mb-md-0">
                                                                            <label for="country"
                                                                                class="text-heading">Quốc gia</label>
                                                                            <select
                                                                                class="form-control border-0 shadow-none form-control-lg selectpicker"
                                                                                title="Select"
                                                                                data-style="btn-lg py-2 h-52"
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="card mb-6">
                                                                    <div class="card-body p-6">
                                                                        <h3
                                                                            class="card-title mb-6 text-heading fs-22 lh-15">
                                                                            Đặt ghim niêm yết trên bản đồ

                                                                        </h3>
                                                                        <div id="map"
                                                                            class="mapbox-gl map-point-animate mb-6"
                                                                            style="height: 296px"
                                                        ...
                                                        <div class="card mb-6">
                                                            <div class="card-body p-6">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <label for="size-in-ft"
                                                                                class="text-heading">Kích thước tính bằng
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <label for="lot-size-in-ft"
                                                                                class="text-heading">Diện tích lô đất tính
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <label for="room"
                                                                                class="text-heading">Phòng</label>
                                                                            <input type="text"
                                                                                class="form-control form-control-lg border-0"
                                                                                id="room" name="rooms">
                                                                        </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <label for="bedrooms"
                                                                                class="text-heading">Phòng ngủ</label>
                                                                            <input type="text"
                                                                                class="form-control form-control-lg border-0"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <label for="bathrooms"
                                                                                class="text-heading">Phòng tắm</label>
                                                                            <input type="text"
                                                                                class="form-control form-control-lg border-0"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <label for="year-built"
                                                                                class="text-heading">Năm xây dựng<span
                                                                                    class="text-muted">(số)</span></label>
                                                                            <input type="text"
                                                                                class="form-control form-control-lg border-0"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <label for="available-from"
                                                                                class="text-heading">Có sẵn từ
                                                                                <span
                                                                                    class="text-muted">(ngày)</span></label>
                                                                            <input type="date"
                                                                                class="form-control form-control-lg border-0"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <label for="basement"
                                                                                class="text-heading">Tầng hầm</label>
                                                                            <input type="text"
                                                                                class="form-control form-control-lg border-0"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <label for="exterior-material"
                                                                                class="text-heading">Vật liệu bên
                                                                                ngoài</label>
                                                                            <input type="text"
                                                                                class="form-control form-control-lg border-0"
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <div class="form-group">
                                                                            <label for="structure-type"
                                                                                class="text-heading">Kiểu cấu trúc</label>
                                                                            <select
                                                                                class="form-control border-0 shadow-none form-control-lg selectpicker"
                                                                                title="Select"
                                                                                data-style="btn-lg py-2 h-52"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group mb-lg-0">
                                                                            <label for="energy-class"
                                                                                class="text-heading">Lớp năng lượng</label>
                                                                            <select
                                                                                class="form-control border-0 shadow-none form-control-lg selectpicker"
                                                                                title="Select"
                                                                                data-style="btn-lg py-2 h-52"
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="form-group mb-lg-0">
                                                                            <label for="energy-index"
                                                                                class="text-heading">Chỉ số năng lượng tính
                                                                                bằng kWh/m2a</label>
                                                                            <select
                                                                                class="form-control border-0 shadow-none form-control-lg selectpicker"
                                                                                title="Select"
