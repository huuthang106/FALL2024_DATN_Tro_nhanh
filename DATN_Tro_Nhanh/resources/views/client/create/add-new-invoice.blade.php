                                            ...
                                            <div class="card">
                                                <div class="card-body p-6">
                                                    <div class="row mb-6">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                placeholder="Nhãn hóa đơn" name="invoice-label"
                                                                value="Invoice Label">
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                    ...
                                                    <div class="mb-6">
                                                            ...
                                                            <table class="table table-bordered item-table">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td
                                                                            class="text-md-right qty d-inline-block d-md-table-cell">
                                                                            <input type="text"
                                                                                class="form-control border-0 shadow-none form-control-lg"
                                                                        ...
                                                                        <td
                                                                            class="text-md-center tax d-inline-block d-md-table-cell">
                                                                            <div class="n-chk">
                                                                                <label
                                                                                    ...
                                                                                    <input type="checkbox"
                                                                                        ...
                                                                                        name="tax[]">
                                                                                    <span
                                                                                        class="d-inline-block d-md-none">Tax</span>
                                                                                </label>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                        ...
                                                        <button type="button"
                                                            class="btn btn-secondary btn-invoice-add-item">Thêm mục
                                                        </button>
                                                    </div>
                                                    <div class="row">
                                        ...
                                        <div class="col-xl-3">
                                            <div class="card card-body mb-6 p-6">
                                                <div class="invoice-action-currency mb-5">
                                                    ...
                                                    <div class="form-group mb-0">
                                                        ...
                                                        <div
                                                            class="dropdown selectable-dropdown invoice-select-currency no-caret">
                                                            ...
                                                            <div class="dropdown-menu" aria-labelledby="currencyDropdown">
                                                                <a class="dropdown-item d-flex"
                                                                    ...
                                                                    <div class="w-18px mr-1 image-flag">
                                                                        <img src="images/svg/flag-us.svg"
                                                                ...
                                                                <a class="dropdown-item d-flex"
                                                                    ...
                                                                    href="javascript:void(0);">
                                                                    <div class="w-18px mr-1 image-flag">
                                                                        <img src="images/svg/flag-idr.svg"
                                                                            class="flag-width" alt="flag">
                                                                    </div>
                                                                ...
                                                                <a class="dropdown-item d-flex"
                                                                    ...
                                                                    href="javascript:void(0);">
                                                                    <div class="w-18px mr-1 image-flag">
                                                                        <img src="images/svg/flag-inr.svg"
                                                                            class="flag-width" alt="flag">
                                                                    </div>
                                                                ...
                                                                <a class="dropdown-item d-flex"
                                                                    ...
                                                                    href="javascript:void(0);">
                                                                    <div class="w-18px mr-1 image-flag">
                                                                        <img src="images/svg/flag-brl.svg"
                                                                            class="flag-width" alt="flag">
                                                                    </div>
                                                                ...
                                                                <a class="dropdown-item d-flex"
                                                                    ...
                                                                    href="javascript:void(0);">
                                                                    <div class="w-18px mr-1 image-flag">
                                                                        <img src="images/svg/flag-de.svg"
                                                                            class="flag-width" alt="flag">
                                                                    </div>
                                                                    <span class="selectable-text">
                                                                        EUR -
                                                                ...
                                                                <a class="dropdown-item d-flex"
                                                                    ...
                                                                    href="javascript:void(0);">
                                                                    <div class="w-18px mr-1 image-flag">
                                                                        <img src="images/svg/flag-try.svg"
                                                                            class="flag-width" alt="flag">
                                                                    </div>
                                                                    <span class="selectable-text">
                                                                        TRY -
                                                ...
                                                <div class="invoice-action-tax mb-5">
                                                    ...
                                                    <div class="invoice-action-tax-fields">
                                                        <div class="form-group mb-0">
                                                            <label>Kiểu</label>
                                                            <div
                                                                class="dropdown selectable-dropdown invoice-tax-select no-caret">
                                                                <a id="typeDropdown"
                                                        ...
                                                        <div class="form-group mb-0 mt-3 tax-rate" style="display: none;">
                                                            ...
                                                            <input type="number"
                                                                ...
                                                                name="tax-rate" id="rate1" placeholder="Rate"
                                                                value="0">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="invoice-action-discount mb-5">
                                                    ...
                                                    <div class="form-group mb-0">
                                                        <label>Kiểu</label>
                                                        <div
                                                            class="dropdown selectable-dropdown invoice-discount-select no-caret">
                                                    ...
                                                    <div class="form-group mb-0 mt-3 discount-amount"
                                                        ...
                                                        <input type="number"
                                                            class="form-control border-0 shadow-none form-control-lg input-rate"
                                                            name="discount-rate" id="amount" placeholder="Rate"
                                                            value="25">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="invoice-actions-btn card card-body p-6">
                                                <div class="invoice-action-btn">
                                                    ...
                                                    <div>
                                                        <button
                                                            class="btn btn-success btn-download btn-block btn-lg">Lưu</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
@push('styleAdmin')
    ...
    <title>Add New Invoice - HomeID</title>
    <!-- Google fonts -->
    <link
