            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb text-light mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Gửi báo cáo</li>
                    </ol>
                </nav>
        ...
        <section class="bg-patten-05 mb-13">
            <div class="container">
                ...
                <p class="text-center mxw-670 mb-8">
                    Trọ Nhanh luôn lắng nghe ý kiến của bạn. Nếu bạn gặp phải bất kỳ vấn đề nào với phòng trọ hoặc khu trọ
                    của mình, hãy cho chúng tôi biết. Chúng tôi sẽ nhanh chóng xử lý để đảm bảo trải nghiệm sống tốt nhất
                    cho bạn.
                </p>
                @if (isset($room))
                    <form class="mxw-774" method="POST" action="{{ route('client.report-store-room') }}">
                        @csrf
                        <input type="hidden" name="room_id" value="{{ $room->id }}">
                        <input type="hidden" name="reported_person" value="{{ $room->user_id }}">
                        <div class="row">
                            <div class="col-md-6 px-2">
                                <div class="form-group">
                                    <input type="hidden" class="form-control form-control-lg border-0" name="status"
                                        value="1">
                                    @error('status')
...
@push('styleUs')
    ...
    <title>Gửi Báo Cáo | TRỌ NHANH</title>
    <!-- Google fonts -->
    <link
