        ...
        <div class="col-md-8 col-lg-6">
          <div class="card border-0 shadow-xxs-2 mb-6">
            <div class="card-body px-8 py-6">
              <h2 class="card-title fs-30 font-weight-600 text-dark lh-16 mb-2 text-center">Đăng Kí</h2>
              <!-- <p class="mb-4 text-center">Chưa có tài khoản? <a href="#" class="text-heading hover-primary"><u>Đăng ký miễn phí</u></a></p> -->
              <form class="form">
                <div class="form-group mb-4">
                  <label for="firstName">Tên</label>
                  <input type="text" class="form-control form-control-lg border-0" id="firstName" name="first-name" placeholder="Tên của bạn">
                </div>
                <div class="form-group mb-4">
                  <label for="lastName">Họ</label>
                  <input type="text" class="form-control form-control-lg border-0" id="lastName" name="last-name" placeholder="Họ của bạn">
                </div>
                <div class="form-group mb-4">
                  <label for="email">Email</label>
                  <input type="text" class="form-control form-control-lg border-0" id="email" name="email" placeholder="Email của bạn">
                </div>
                <div class="form-group mb-4">
                  <label for="password-1">Mật khẩu</label>
                  <div class="input-group input-group-lg">
                    <input type="password" class="form-control border-0 shadow-none fs-13" id="password-1" name="password" placeholder="Mật khẩu">
                ...
                <div class="form-group mb-4">
                  ...
                  <div class="input-group input-group-lg">
                    <input type="password" class="form-control border-0 shadow-none fs-13" id="re-password" name="re-password" placeholder="Nhập lại mật khẩu">
                    <div class="input-group-append">
                      <span class="input-group-text bg-gray-01 border-0 text-body fs-18">
                        <i class="far fa-eye-slash"></i>
                      </span>
              ...
              <div class="row no-gutters mx-n2">
                <div class="col-sm-6 px-2 mb-4">
                  <a href="#" class="btn btn-lg btn-block text-heading border px-0 bg-hover-accent">
                    <img src="{{ asset('assets/images/facebook.png') }}" alt="Facebook" class="mr-2">Facebook
                  </a>
                </div>
                <div class="col-sm-6 px-2 mb-4">
                  <a href="#" class="btn btn-lg btn-block text-heading border px-0 bg-hover-accent">
