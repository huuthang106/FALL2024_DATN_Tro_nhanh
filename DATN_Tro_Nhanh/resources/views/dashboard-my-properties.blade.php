                    ...
                    <ul class="list-group list-group-no-border rounded-lg">
                      ...
                      <li class="list-group-item px-3 px-xl-4 py-2 sidebar-item">
                        <a href="dashboard-my-properties.html"
                          ...
                          <span class="sidebar-item-text">Quản Lí Thuộc Tính</span>
                  ...
                  <div class="dropdown border-md-right border-0 py-3 text-right">
                    <a href="#"
                      ...
                      <div class="mr-4 w-48px">
                        <img src="{{ asset('assets/images/testimonial-5.jpg') }}" alt="Nhân Tống" class="rounded-circle">
                  ...
                  <tbody>
                    <tr class="shadow-hover-xs-2 bg-hover-white">
                        ...
                        <div class="media">
                          <div class="w-120px mr-4 position-relative">
                            <a href="single-property-1.html">
                              <img src="{{ asset('assets/images/my-properties-01.jpg') }}" alt="Nhà ở Metric Way" class="img-fluid">
                            </a>
                      ...
                      <td class="align-middle">
                        <span
                            class="badge text-capitalize font-weight-normal fs-12 badge-yellow">chờ duyệt</span>
                      </td>
                      <td class="align-middle">2049</td>
                      <td class="align-middle">
                        <a href="#" data-toggle="tooltip" title="Chỉnh sửa" class="d-inline-block fs-18 text-muted hover-primary mr-5"><i
                            class="fal fa-pencil-alt"></i></a>
                        <a href="#" data-toggle="tooltip" title="Xóa" class="d-inline-block fs-18 text-muted hover-primary"><i
                    ...
                    <tr class="shadow-hover-xs-2 bg-hover-white">
                      <td class="align-middle pt-6 pb-4 px-6">
                        <div class="media">
                          <div class="w-120px mr-4 position-relative">
                            <a href="single-property-1.html">
                              <img src="{{ asset('assets/images/my-properties-02.jpg') }}" alt="Nhà ở Metric Way" class="img-fluid">
                                     alt="Nhà gỗ Gingerbread">
                            </a>
                      ...
                      <td class="align-middle">
                        <span
                            class="badge text-capitalize font-weight-normal fs-12 badge-pink">đã xuất bản</span>
                      </td>
                      <td class="align-middle">2049</td>
                      <td class="align-middle">
                        <a href="#" data-toggle="tooltip" title="Chỉnh sửa" class="d-inline-block fs-18 text-muted hover-primary mr-5"><i
                    ...
                    <tr class="shadow-hover-xs-2 bg-hover-white">
                      <td class="align-middle pt-6 pb-4 px-6">
                        <div class="media">
                          <div class="w-120px mr-4 position-relative">
                            <a href="single-property-1.html">
                              <img src="{{ asset('assets/images/my-properties-03.jpg') }}" alt="Nhà ở Metric Way" class="img-fluid">
                      ...
                      <td class="align-middle">
                        <span
                            class="badge text-capitalize font-weight-normal fs-12 badge-pink">đang xử lý</span>
                      </td>
                      <td class="align-middle">2049</td>
                      <td class="align-middle">
                        <a href="#" data-toggle="tooltip" title="Chỉnh sửa" class="d-inline-block fs-18 text-muted hover-primary mr-5"><i
                    ...
                    <tr class="shadow-hover-xs-2 bg-hover-white">
                      <td class="align-middle pt-6 pb-4 px-6">
                        <div class="media">
                          <div class="w-120px mr-4 position-relative">
                            <a href="single-property-1.html">
                              <img src="{{ asset('assets/images/my-properties-04.jpg') }}" alt="Nhà ở Metric Way" class="img-fluid">
                    ...
                    <tr class="shadow-hover-xs-2 bg-hover-white">
                      <td class="align-middle pt-6 pb-4 px-6">
                        <div class="media">
                          <div class="w-120px mr-4 position-relative">
                            <a href="single-property-1.html">
                              <img src="{{ asset('assets/images/my-properties-05.jpg') }}" alt="Nhà ở Metric Way" class="img-fluid">
