                ...
                <div class="d-flex align-items-center">
                    <nav class="navbar navbar-expand-xl bg-transparent px-0 w-100 w-xl-auto">
                        ...
                        <div class="collapse navbar-collapse mt-3 mt-xl-0" id="primaryMenu02">
                            <ul class="navbar-nav hover-menu main-menu px-0 mx-xl-n4">
                                ...
                                <li id="navbar-item-dashboard" aria-haspopup="true" aria-expanded="false"
                                    ...
                                    <ul class="dropdown-menu pt-3 pb-0 pb-xl-3"
                                        ...
                                        <li class="dropdown-item">
                                            <a id="navbar-link-my-properties" class="dropdown-link" href="{{ route('owner.owners.properties') }}">
                                                Căn Hộ
                                            </a>
                                        </li>
                                    ...
                                    <ul class="dropdown-menu pt-3 pb-0 pb-xl-3" aria-labelledby="navbar-item-pages">
                                        <li class="dropdown-item dropdown dropright">
                                            ...
                                            <ul class="dropdown-menu dropdown-submenu pt-3 pb-0 pb-xl-3"
                                                ...
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="blog-grid-with-sidebar.html">Blog
                                                        grid with sidebar</a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="blog-list-width-sidebar.html">Blog
                                                        list with sidebar</a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="blog-details-1.html">Blog details
                                                        1</a>
                                                </li>
                                                <li class="dropdown-item">
                                        ...
                                        <li class="dropdown-item dropdown dropright">
                                            ...
                                            <ul class="dropdown-menu dropdown-submenu pt-3 pb-0 pb-xl-3"
                                                ...
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="agents-grid-1.html">Agents grid
                                                        1</a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="agents-grid-2.html">Agents grid
                                                        2</a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link"
                                                        href="agents-grid-with-sidebar.html">Agents grid with
                                                        sidebar</a>
                                                </li>
                                                <li class="dropdown-item">
                                        ...
                                        <li class="dropdown-item dropdown dropright">
                                            ...
                                            <ul class="dropdown-menu dropdown-submenu pt-3 pb-0 pb-xl-3"
                                                ...
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="agency-details-1.html">Agency
                                                        details 1</a>
                                                </li>
                                                <li class="dropdown-item">
                                                    <a class="dropdown-link" href="agency-details-2.html">Agency
                                                        details 2</a>
                                                </li>
                                            </ul>
                                        </li>
                            ...
                            <div class="d-block d-xl-none"><div class="modal fade login-register login-register-modal" id="login-register-modal" tabindex="-1" role="dialog"
                                aria-labelledby="login-register-modal" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered mxw-571" role="document">
                                  <div class="modal-content">
                                    <div class="modal-header border-0 p-0">
