            ...
            <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
                        ...
                        <div class="p-2">
                            <div class="d-flex form-group mb-0 align-items-center">
                                ...
                                <select class="form-control selectpicker form-control-lg mr-2 "
                                    wire:model.lazy="timeFilters" data-style="bg-white btn-lg h-52 py-2 border">
                ...
                <div class="row g-3">
                    @if ($favourites->isEmpty())
                        <div class="col-12">
                            <p class="text-center">Không có yêu thích nào!</p>
                        </div>
                    @else
                                    ...
                                    <div class="card-body pt-3">
                                        ...
                                        <ul class="list-inline d-flex mb-0 flex-wrap">
                                            <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-2"
                                                data-toggle="tooltip"
                                                title="{{ $favourite->room->bedrooms }} Phòng ngủ">
                                            ...
                                            <li class="list-inline-item text-gray font-weight-500 fs-13 d-flex align-items-center mr-2"
                                                data-toggle="tooltip"
                                                title="{{ $favourite->room->bathrooms }} Phòng tắm">
                    ...
                    <nav aria-label="Page navigation">
                        <ul class="pagination rounded-active justify-content-center">
                            ...
                            <li class="page-item {{ $currentPage == 1 ? 'disabled' : '' }}">
                                <a class="page-link hover-white" wire:click.prevent="gotoPage(1)"
                                    wire:loading.attr="disabled" aria-label="First">
                            ...
                            @if ($totalPages > 1)
                                <li class="page-item {{ $currentPage == $totalPages ? 'active' : '' }}">
                                    <a class="page-link hover-white"
                                        wire:click.prevent="gotoPage({{ $totalPages }})"
                            ...
                            <!-- Last Page Button -->
                            <li class="page-item {{ $currentPage == $totalPages ? 'disabled' : '' }}">
                                <a class="page-link hover-white" wire:click.prevent="gotoPage({{ $totalPages }})"
