...
@push('scriptsAdmin')
    ...
    <script>
        document.getElementById('acreageForm').addEventListener('submit', function(event) {
            // Lấy giá trị của min_size và max_size
            var minSizeInput = document.getElementById('min_size');
            var maxSizeInput = document.getElementById('max_size');

            // Thêm đơn vị "m²" vào giá trị
            minSizeInput.value = minSizeInput.value + ' m²';
            maxSizeInput.value = maxSizeInput.value + ' m²';
        });
    </script>
@endpush
