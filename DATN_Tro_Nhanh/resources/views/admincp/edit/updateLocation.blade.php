...
@section('titleAdmin', 'Chỉnh Sửa Gói Tin | TRỌ NHANH')
@section('linkAdmin', 'Chỉnh sửa gói tin')
                ...
                <div class="card mb-5 mb-xl-10">
                    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">Chỉnh sửa gói tin</h3>
                        </div>
                    </div>
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            <select name="status" class="form-select form-select-solid form-select-lg">
                                                <option value="1" {{ $locations->status == 1 ? 'selected' : '' }}>Kích
                                                    hoạt
                                                </option>
                                                <option value="0" {{ $locations->status == 0 ? 'selected' : '' }}>
                                                    Không
                                                    kích
                                                    hoạt</option>
                                            </select>
...
@push('styleAdmin')
    <base href="{{ asset('..') }}">
    {{-- <title>Chỉnh Sửa Gói Tin | TRỌ NHANH</title> --}}
