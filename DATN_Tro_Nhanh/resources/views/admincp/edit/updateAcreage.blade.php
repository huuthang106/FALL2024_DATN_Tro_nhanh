...
@section('titleAdmin', 'Chỉnh Sửa Diện Tích | TRỌ NHANH')
@section('linkAdmin', 'Chỉnh sửa diện tích')
                ...
                <div class="card mb-5 mb-xl-10">
                    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">Sửa diện tích</h3>
                        </div>
                    </div>
                    <div id="kt_account_profile_details" class="collapse show">
                        <form class="form" action="{{ route('admin.update-acreage', ['id' => $acreages->id]) }}"
                            method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body border-top p-9">
                                <div class="row">
                                    <div class="row mb-6">
                                        <label class="col-lg-4 col-form-label fw-bold fs-6 required">Tên diện tích</label>
                                    ...
                                    <div class="row mb-6">
                                        ...
                                        <div class="col-lg-8 fv-row">
                                            <select name="status" class="form-select form-select-solid form-select-lg">
                                                <option value="1" {{ $acreages->status == 1 ? 'selected' : '' }}>Kích
                                                    hoạt
                                                </option>
                                                <option value="0" {{ $acreages->status == 0 ? 'selected' : '' }}>
                                                    Không
                                                    kích
                                                    hoạt</option>
                                            </select>
...
@push('styleAdmin')
    <base href="{{ asset('..') }}">
    {{-- <title>Chỉnh Sửa Diện Tích | TRỌ NHANH</title> --}}
