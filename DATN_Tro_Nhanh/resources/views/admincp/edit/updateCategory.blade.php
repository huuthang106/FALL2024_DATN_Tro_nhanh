...
@section('titleAdmin', 'Chỉnh Sửa Loại Phòng | TRỌ NHANH')
                ...
                <div class="card mb-5 mb-xl-10">
                    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">Chỉnh sửa loại phòng</h3>
                        </div>
                    </div>
                    <div id="kt_account_profile_details" class="collapse show">
                        <form class="form" action="{{ route('admin.update-category', ['id' => $category->id]) }}"
                            ...
                            <div class="card-body border-top p-9">
                                <!-- Name Input Group -->
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label fw-bold fs-6 required">Tên loại phòng</label>
                                ...
                                <!-- Status Input Group -->
                                <div class="row mb-6">
                                    <label class="col-lg-4 col-form-label fw-bold fs-6 required" for="status">Trạng
                                        thái</label>
                                    <div class="col-lg-8 fv-row">
                                        <select id="status" name="status"
                                            class="form-select form-select-solid form-select-lg">
                                            <option value="1"{{ $category->status ? 'selected' : '' }}>Kích hoạt
                                            </option>
                                            <option value="0"{{ !$category->status ? 'selected' : '' }}>Không kích hoạt
                                            </option>
                                        </select>
                                    </div>
                                </div>
