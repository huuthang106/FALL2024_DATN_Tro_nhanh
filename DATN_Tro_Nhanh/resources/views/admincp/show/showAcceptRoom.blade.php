                        ...
                        <nav class="mt-4">
                            <ul class="pagination rounded-active justify-content-center">
                                ...
                                @if ($endPage < $rooms->lastPage())
                                    ...
                                    @endif
                                    <li class="page-item">
                                        <a class="page-link" href="{{ $rooms->url($rooms->lastPage()) }}">{{ $rooms->lastPage() }}</a>
                                    </li>
                                @endif
                                ...
                                @if ($rooms->hasMorePages())
                                    <li class="page-item">
                                        <a class="page-link" href="{{ $rooms->url($rooms->lastPage()) }}">
...
@push('styleAdmin')
    <base href="{{ asset('..') }}">
    {{-- <title>Danh Sách Tất Cả Phòng Trọ | TRỌ NHANH</title> --}}
