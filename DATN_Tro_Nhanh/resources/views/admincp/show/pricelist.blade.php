...
@section('titleAdmin', 'Danh Sách Vị Trí Gói | TRỌ NHANH')
@section('linkAdmin', 'Danh sách vị trí gói')
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <!--end::Export-->
                                <!--begin::Add user-->
                                <a type="button" href="{{ route('admin.trang-them-bang-gia') }}" class="btn btn-primary">
                                    Thêm bảng giá</a>
                                ...
                                <div class="modal-dialog modal-dialog-centered mw-650px">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header" id="kt_modal_add_user_header">
                                            <!--begin::Modal title-->
                                            <h2 class="fw-bolder">Thêm tiện ích</h2>
                                            <!--end::Modal title-->
                                            <!--begin::Close-->
                                            <div class="btn btn-icon btn-sm btn-active-icon-primary"
                                                data-kt-users-modal-action="close">
                            ...
                            <nav aria-label="Page navigation">
                                <ul class="pagination rounded-active justify-content-center">
                                    ...
                                    <li class="page-item {{ $priceLists->onFirstPage() ? 'disabled' : '' }}">
                                        <a class="page-link hover-white" href="{{ $priceLists->previousPageUrl() }}"
                                    ...
                                    <li class="page-item {{ $currentPage == 1 ? 'active' : '' }}">
                                        <a class="page-link hover-white" href="{{ $priceLists->url(1) }}">1</a>
                                    </li>
                                    ...
                                    @if ($totalPages > 1)
                                        <li class="page-item {{ $currentPage == $totalPages ? 'active' : '' }}">
                                            <a class="page-link hover-white"
                                                href="{{ $priceLists->url($totalPages) }}">{{ $totalPages }}</a>
                                        </li>
                                    @endif

                                    {{-- Liên kết Trang Tiếp --}}
                                    <li class="page-item {{ !$priceLists->hasMorePages() ? 'disabled' : '' }}">
                                        <a class="page-link hover-white" href="{{ $priceLists->nextPageUrl() }}"
