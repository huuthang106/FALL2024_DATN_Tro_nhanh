                        ...
                        <a href="#" class="card bg-body-white hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-gray-900 fw-bolder fs-2 mb-2 mt-5">
                                    Giỏ hàng</div>
                                <div class="fw-bold text-gray-400">Đất, Nhà, Ranchos, Trang Trại</div>
                            </div>
                            <!--end::Body-->
                        </a>
                    ...
                    <div class="col-xl-4">
                        ...
                        <a href="#" class="card bg-primary hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-white fw-bolder fs-2 mb-2 mt-5">Căn hộ</div>
                                <div class="fw-bold text-white">Căn hộ, Phòng chung, Nhà song lập</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
                    ...
                    <div class="col-xl-4">
                        ...
                        <a href="#" class="card bg-dark hoverable card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-gray-100 fw-bolder fs-2 mb-2 mt-5">Thống kê bán hàng</div>
                                <div class="fw-bold text-gray-100">Tăng 50% cho năm tài khóa 20</div>
                            </div>
                            <!--end::Body-->
                        </a>
                        <!--end::Statistics Widget 5-->
