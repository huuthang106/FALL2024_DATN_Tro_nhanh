...
@section('titleAdmin', 'Chỉnh Sửa Hồ Sơ | TRỌ NHANH')
@section('linkAdmin', 'Chỉnh sửa hồ sơ')
            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">Thông tin tài khoản</h3>
                        </div>
                        <!--end::Card title-->
                    </div>
                    <!--begin::Card header-->
                        ...
                        <form class="form" method="POST"
                            ...
                            <div class="card-body border-top p-9">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="image-input image-input-outline" data-kt-image-input="true"
                                            ...
                                            <div class="image-input-wrapper w-125px h-125px"
                                                style="background-image: url({{ asset('assets/images/' . $user->image) }})">
                                            </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <select class="form-select form-select-lg form-select-solid" id="city-province"
                                            name="province">
                                ...
                                <div class="row mb-6">
                                    <!--begin::Label-->
                                    <label class="col-lg-4 col-form-label fw-bold fs-6">
                                        <span class="required" for="district-town">Huyện</span>
                                        <i class="fas fa-exclamation-circle ms-1 fs-7" data-bs-toggle="tooltip"
                                            title=""></i>
                                    </label>
                                    <!--end::Label-->
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row">
                                        <select class="form-select form-select-lg form-select-solid" title="Lựa chọn"
                                            data-style="btn-lg py-2 h-52" id="district-town" name="district">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <select class="form-select form-select-lg form-select-solid" title="Lựa chọn"
                                            data-style="btn-lg py-2 h-52" id="ward-commune" name="village">
                                            <!-- Các tùy chọn khác sẽ được thêm vào qua JavaScript -->
                                        </select>
                                    </div>
                                    <!--end::Col-->
                            ...
                            <div class="card-footer d-flex justify-content-end py-6 px-9">
                                <button type="reset" class="btn btn-light btn-active-light-primary me-2">Hủy bỏ</button>
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
                        ...
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">Bảo mật</h3>
                        </div>
                    </div>
                    <!--end::Card header-->
                    <!--begin::Content-->
...
@push('styleAdmin')
    <base href="{{ asset('..') }}">
    {{-- <title>Chỉnh Sửa Hồ Sơ | TRỌ NHANH</title> --}}
