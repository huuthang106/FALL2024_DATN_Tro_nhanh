...
@section('titleOwners', 'Dashboard | TRỌ NHANH')
                                ...
                                <ul class="nav nav-pills justify-content-end d-none d-sm-flex nav-pills-01" role="tablist">
                                    ...
                                    <li class="nav-item px-5 py-1">
                                        <a class="nav-link bg-transparent shadow-none p-0 letter-spacing-1" id="weekly-tab"
                                            ...
                                            aria-selected="false">Hàng tuần</a>
                                    </li>
                                    <li class="nav-item px-5 py-1">
...
@push('styleOwners')
    ...
    <meta name="description"
        content="Trang Dashboard của TRỌ NHANH cung cấp cái nhìn tổng quan và các công cụ quản lý cho quản trị viên và người dùng, giúp theo dõi và quản lý các hoạt động liên quan đến khu trọ và người thuê.">
    <meta name="author" content="TRỌ NHANH">
    <meta name="generator" content="TRỌ NHANH">
    <!-- Google fonts -->
    <link
    ...
    <meta name="twitter:title" content="Dashboard | TRỌ NHANH">
    <meta name="twitter:description"
        content="Trang Dashboard của TRỌ NHANH giúp quản lý các hoạt động và theo dõi thông tin liên quan đến khu trọ và người thuê, cung cấp cái nhìn tổng quan và công cụ quản lý hiệu quả.">
    <meta name="twitter:image" content="{{ asset('assets/images/tro-moi.png') }}">
    <!-- Facebook -->
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="Dashboard | TRỌ NHANH">
    <meta property="og:description"
        content="Trang Dashboard của TRỌ NHANH cung cấp cái nhìn tổng quan và công cụ quản lý cho quản trị viên và người dùng, giúp theo dõi và quản lý các hoạt động liên quan đến khu trọ và người thuê.">
    <meta property="og:type" content="website">
