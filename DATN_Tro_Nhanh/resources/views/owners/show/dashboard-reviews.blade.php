...
@section('titleOwners', 'Danh Sách Đánh Giá | TRỌ NHANH')
            ...
            <div class="card border-0 mb-4">
                <div class="card-body p-0 p-sm-8 p-4">
                    ...
                    <div class="media border-top py-6 d-sm-flex d-block text-sm-left text-center">
                        <img src="{{ asset('assets/images/review-07.jpg') }}" alt="Vernon Fisher"
                        ...
                        <div class="media-body">
                            ...
                            <p class="mb-3 pr-xl-17">Hỗ trợ rất tốt và nhanh chóng trong tuần. Cảm ơn bạn
                                đã luôn
                                cập nhật các chủ đề WordPress của mình. Mức độ hỗ trợ và sự tận tâm của bạn
                                không ai sánh kịp.</p>
...
@push('styleOwners')
    ...
    <meta name="description"
        content="Danh sách các đánh giá và nhận xét từ khách hàng về các khu trọ trên TRỌ NHANH. Đọc ý kiến từ những người đã trải nghiệm và tìm hiểu thêm về chất lượng dịch vụ.">
    <meta name="author" content="TRỌ NHANH">
    <meta name="generator" content="TRỌ NHANH">
    <!-- Google fonts -->
    <link
    ...
    <meta name="twitter:title" content="Danh Sách Đánh Giá tại TRỌ NHANH">
    <meta name="twitter:description"
        content="Xem danh sách các đánh giá và nhận xét từ khách hàng về các khu trọ trên TRỌ NHANH. Tìm hiểu ý kiến và trải nghiệm của người dùng để đưa ra quyết định tốt nhất.">
    <meta name="twitter:image" content="{{ asset('assets/images/tro-moi.png') }}">
    <!-- Facebook -->
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="Danh Sách Đánh Giá tại TRỌ NHANH">
