...
@section('titleOwners', 'Danh Sách Yêu Thích | TRỌ NHANH')
...
@push('styleOwners')
    ...
    <meta name="description"
        content="Danh sách các mục yêu thích của bạn tại TRỌ NHANH. Xem lại và quản lý các mục đã được bạn đánh dấu yêu thích.">
    <meta name="author" content="TRỌ NHANH">
    <meta name="generator" content="TRỌ NHANH">
    ...
    <meta name="twitter:title" content="Danh Sách Yêu Thích | TRỌ NHANH">
    <meta name="twitter:description"
        content="Danh sách các mục yêu thích của bạn tại TRỌ NHANH. Xem lại và quản lý các mục đã được bạn đánh dấu yêu thích.">
    <meta name="twitter:image" content="{{ asset('assets/images/tro-moi.png') }}">

    <!-- Facebook -->
    <meta property="og:url" content="{{ url('/danh-sach-yeu-thich') }}">
    <meta property="og:title" content="Danh Sách Yêu Thích | TRỌ NHANH">
