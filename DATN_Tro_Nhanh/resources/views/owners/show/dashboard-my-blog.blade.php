                ...
                <table class="table table-hover bg-white border rounded-lg">
                  <thead class="thead-sm thead-black">
                    <tr>
                      ...
                      <th scope="col" class="border-top-0 pt-5 pb-4">Ngày</th>
                        ...
                        <div class="media">
                          ...
                          <div class="media-body">
                            <a href="single-property-1.html" class="text-dark hover-primary">
                              <h5 class="fs-16 mb-0 lh-18">Title</h5>
                            </a>
                            {{-- <p class="mb-1 font-weight-500">address</p> --}}
                            <span class="text-heading lh-15 font-weight-bold fs-17">price</span>
