...
@livewire('invoice-preview', ['billId' => $bill->id])
@endsection
@push('styleOwners')
    {{-- <meta charset="utf-8">
    ...
    <meta name="description"
        content="Xem trước hóa đơn chi tiết trên trang TRỌ NHANH. Quản lý và kiểm tra hóa đơn dễ dàng và hiệu quả.">
    <meta name="author" content="TRỌ NHANH">
    <meta name="generator" content="TRỌ NHANH">
    <!-- Google fonts -->
    <link
    ...
    <meta name="twitter:title" content="Xem Trước Hóa Đơn tại TRỌ NHANH">
    <meta name="twitter:description"
        content="Xem trước hóa đơn chi tiết và quản lý các hóa đơn dễ dàng trên trang TRỌ NHANH. Đảm bảo mọi thông tin hóa đơn được hiển thị chính xác và đầy đủ.">
    <meta name="twitter:image" content="{{ asset('assets/images/tro-moi.png') }}">
    <!-- Facebook -->
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="Xem Trước Hóa Đơn tại TRỌ NHANH">
    <meta property="og:description"
        content="Xem trước hóa đơn chi tiết và quản lý các hóa đơn trên TRỌ NHANH. Đảm bảo thông tin hóa đơn chính xác và dễ dàng truy cập.">
    <meta property="og:type" content="website">
