                                        ...
                                        <div class="row mb-6">
                                            <div class="invoice-logo col-md-6 mb-3 mb-md-0">
                                                ...
                                                <div class="dropzone upload-file text-center py-5" data-uploader="true"
                                                    ...
                                                    <div class="dz-default dz-message">
                                                        ...
                                                        <p class="text-heading fs-22 lh-15 mb-4">Kéo thả ảnh hoặc</p>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text"
                                                    ...
                                                    placeholder="Invoice Label" name="invoice-label" value="Nhãn hóa đơn">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 invoice-address-company">
                                                ...
                                                <div class="invoice-address-company-fields">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            class="form-control border-0 shadow-none form-control-lg"
                                                            id="company-name" placeholder="Văn Admin" name="name">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="company-email" class="text-heading">Email</label>
                                                        <input type="text"
                                                            class="form-control border-0 shadow-none form-control-lg"
                                                            id="company-email" placeholder="vanadmin@gmail.com"
                                                            name="email">
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            class="form-control border-0 shadow-none form-control-lg"
                                                            id="company-address" placeholder="TP.Cần Thơ" name="address">
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            class="form-control border-0 shadow-none form-control-lg"
                                                            id="company-phone" placeholder="(039) 456 7891" name="phone">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 invoice-address-client">
                                                ...
                                                <div class="invoice-address-client-fields">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            class="form-control border-0 shadow-none form-control-lg"
                                                            id="client-email" placeholder="nguoinhan@gmail.com"
                                                            name="client-email">
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            class="form-control border-0 shadow-none form-control-lg"
                                                            id="client-address" placeholder="Đồng Tháp"
                                                            name="client-address">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="client-phone" class="text-heading">Số điện thoại</label>
                                                        <input type="text"
                                                            class="form-control border-0 shadow-none form-control-lg"
                                                            id="client-phone" placeholder="(039) 456 7891"
                                                            name="client-phone">
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td
                                                                ...
                                                                <input type="text"
                                                                    ...
                                                                    placeholder="Mặt hàng" name="description[]">
                                                                <select
                                                                    class="form-control border-0 shadow-none form-control-lg"
                                                            ...
                                                            <td class="text-md-right qty d-inline-block d-md-table-cell">
                                                                <input type="text"
                                                                    class="form-control border-0 shadow-none form-control-lg"
                                                                    placeholder="Số lượng" name="quality[]">
                                                            </td>
                                                            <td
                            ...
                            <div class="col-xl-3">
                                <div class="card card-body mb-6 p-6">
                                    <div class="invoice-action-currency mb-5">
                                        <h5 class="card-title fs-16 lh-2 text-dark mb-3">Đơn vị tiền</h5>
                                            ...
                                            <div class="dropdown selectable-dropdown invoice-select-currency no-caret">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="currencyDropdown">
                                                    <a class="dropdown-item d-flex"
                                                        ...
                                                        <div class="w-18px mr-1 image-flag">
                                                            <img src="{{ asset('asset/images/svg/flag-us.svg') }}"
...
@push('styleOwners')
    ...
    <meta name="description"
        content="Xem trước hóa đơn cho các giao dịch liên quan đến bất động sản. Trang này cung cấp cái nhìn tổng quan chi tiết về các hóa đơn, bao gồm thông tin thanh toán, mô tả và trạng thái.">
    ...
    <meta name="twitter:description"
        content="Xem trước các hóa đơn giao dịch bất động sản, bao gồm thông tin chi tiết về thanh toán, mô tả và trạng thái. Trang này giúp bạn dễ dàng theo dõi các hóa đơn của mình.">
