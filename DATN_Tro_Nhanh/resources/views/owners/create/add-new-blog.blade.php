            ...
            @else
                <div class="collapse-tabs new-property-step">
                    ...
                    <div class="tab-content shadow-none p-0">
                        <form id="blogForm" action="{{ route('owners.create-blog') }}" method="POST"
                                            ...
                                            <div class="card-body py-4 py-md-0 px-0">
                                                <div class="row d-flex justify-content-center">
                                                    <div class="col-lg-10">
                                                        <div class="card mb-6">
                                                            <div class="card-body p-6">
                                                                <h3 class="card-title mb-0 text-heading fs-22 lh-15">Tải
                                                                    lên
...
@push('styleOwners')
    ...
    <meta name="description"
        content="Thêm bài viết blog về bất động sản, chia sẻ kinh nghiệm và mẹo tìm thuê nhà trọ trên TRỌ NHANH.">
    ...
    <meta name="twitter:title" content="Thêm Blog - TRỌ NHANH">
    <meta name="twitter:description"
        content="Viết và chia sẻ bài viết blog về nhà trọ, kinh nghiệm và lời khuyên về việc thuê nhà.">
    <meta name="twitter:image" content="{{ asset('assets/images/tro-moi.png') }}">
    <!-- Facebook -->
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="Thêm Blog - TRỌ NHANH">
    <meta property="og:description" content="Chia sẻ bài viết blog về bất động sản và kinh nghiệm thuê nhà hiệu quả.">
...
@endpush
@push('scriptOwners')
    {{-- <script src="{{ asset('assets/js/t') }}"></script> --}}
