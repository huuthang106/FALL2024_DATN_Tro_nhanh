...
@section('titleOwners', 'Đổi Mật Khẩu | TRỌ NHANH')
@section('contentOwners')
    <main id="content" class="bg-gray-01">
        <div class="px-3 px-lg-6 px-xxl-13 py-5 py-lg-10">
            {{-- <div class="mb-6">
                <h2 class="mb-0 text-heading fs-22 lh-15">ĐỔI MẬT KHẨU
                </h2>
...
@push('styleOwners')
    ...
    <meta name="description"
        content="Đổi mật khẩu cho tài khoản của bạn trên TRỌ NHANH. Đảm bảo tính bảo mật cho tài khoản bằng cách cập nhật mật khẩu thường xuyên.">
    ...
    <meta name="twitter:title" content="Đổi Mật Khẩu - TRỌ NHANH">
    <meta name="twitter:description"
        content="Thay đổi mật khẩu tài khoản của bạn để đảm bảo an toàn thông tin và bảo mật trên TRỌ NHANH.">
    <meta name="twitter:image" content="{{ asset('assets/images/tro-moi.png') }}">
    <!-- Facebook -->
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="Đổi Mật Khẩu - TRỌ NHANH">
    <meta property="og:description"
        content="Thay đổi mật khẩu cho tài khoản của bạn một cách an toàn trên TRỌ NHANH để bảo vệ thông tin cá nhân.">
    <meta property="og:type" content="website">
