                                    ...
                                    <div class="card-body p-6">
                                        <div class="row mb-6">
                                            <div class="invoice-logo col-md-6 mb-3 mb-md-0">
                                                <h4 class="card-title mb-5 text-heading fs-22 lh-15">Logo Hóa Đơn</h4>
                                                <div class="dropzone upload-file text-center py-5" data-uploader="true"
                                                    data-uploader-image="{{ asset('assets/images/logo.png') }}"
                                                    id="myDropzone" data-uploader-url="./dashboard-edit-invoice.html">
                                                    <div class="dz-default dz-message">
                                                        <span class="upload-icon lh-1 d-inline-block mb-4"><i
                                                                class="fal fa-cloud-upload-alt"></i></span>
                                                        <p class="text-heading fs-22 lh-15 mb-4">Kéo thả hoặc</p>
                                                        <button class="btn btn-indigo px-7 mb-2" type="button">
                                                            Tải ảnh lên
                                                        </button>
                                                        <input type="file" hidden name="file" value="images/logo.png">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <h4 class="card-title mb-5 text-heading fs-22 lh-15">Nhãn Hóa Đơn</h4>
                                                <input type="text"
                                                    class="form-control border-0 shadow-none form-control-lg"
                                                    placeholder="Invoice Label" name="invoice-label" value="Tìm trọ nhanh">
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 invoice-address-company">
                                                ...
                                                <div class="invoice-address-company-fields">
                                                    <div class="form-group">
                                                        <label for="company-name" class="text-heading">Họ và Tên</label>
                                                        <input type="text"
                                                            class="form-control border-0 shadow-none form-control-lg"
                                                            id="company-name" placeholder="Nhập tên..."
                                                            value="Tìm trọ nhanh" name="name">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="company-email" class="text-heading">Email</label>
                                                        <input type="text"
                                                            class="form-control border-0 shadow-none form-control-lg"
                                                            id="company-email" placeholder="Nhập Email..."
                                                            value="vanadmin@gmail.com" name="email">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="company-address" class="text-heading">Địa chỉ</label>
                                                        <input type="text"
                                                            class="form-control border-0 shadow-none form-control-lg"
                                                            id="company-address" placeholder="Nhập địa chỉ..."
                                                            value="Quận Cái Răng, TP.Cần Thơ" name="address">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="company-phone" class="text-heading">Số điện
                                                            thoại</label>
                                                        <input type="text"
                                                            class="form-control border-0 shadow-none form-control-lg"
                                                            id="company-phone" placeholder="Nhập số điện thoại..."
                                                            value="(039) 456 7891" name="phone">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 invoice-address-client">
                                                <h4 class="card-title mb-5 text-heading fs-22 lh-15">Hóa Đơn Tới</h4>
                                                <div class="invoice-address-client-fields">
                                                    <div class="form-group">
                                                        <label for="client-name" class="text-heading">Họ và Tên</label>
                                                        <input type="text"
                                                            class="form-control border-0 shadow-none form-control-lg"
                                                            id="client-name" placeholder="Nhập tên..." value="Jesse Cory"
                                                            name="client-name">
                                                    </div>
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"
                                                            class="form-control border-0 shadow-none form-control-lg"
                                                            id="client-email" placeholder="Nhập Email..."
                                                            value="redq@company.com" name="client-email">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="client-address" class="text-heading">Địa chỉ</label>
                                                        <input type="text"
                                                            class="form-control border-0 shadow-none form-control-lg"
                                                            id="client-address" placeholder="Nhập địa chỉ..."
                                                            value="405 Mulberry Rd. Mc Grady, NC, 28649"
                                                            name="client-address">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="client-phone" class="text-heading">Số điện
                                                            thoại</label>
                                                        <input type="text"
                                                            class="form-control border-0 shadow-none form-control-lg"
                                                            id="client-phone" placeholder="Nhập số điện thoại..."
                                                            value="(394) 666 0701" name="client-phone">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group mb-4">
                                                    ...
                                                    <input type="date" class="form-control form-control-lg border-0"
                                                        id="date" placeholder="Thêm ngày" name="available-from"
                                                        value="2021-04-07">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                        ...
                                        <div class="mb-6">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="rate d-inline-block d-md-table-cell">
                                                                <input type="text"
                                                                    class="form-control border-0 shadow-none form-control-lg"
                                                                    placeholder="Giá" value="65" name="price[]">
                                                            </td>
                                                                ...
                                                                <div class="n-chk">
                                                                    <label
                                                                        ...
                                                                        <input type="checkbox" class="new-control-input"
                                                                            name="tax[]">
                                                                        <span class="d-inline-block d-md-none">Thuế</span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                        </tr>
                                            ...
                                            <button type="button" class="btn btn-secondary btn-invoice-add-item">Thêm mặt
                                                hàng
                                            </button>
                                        </div>
                                        <div class="row">
                                                ...
                                                <div
                                                    ...
                                                    <div class="list-group list-group-flush">
                                                        <div class="list-group-item d-flex py-2 px-0">
                                                            <div class="invoice-summary-label">Tổng phụ thu</div>
                                        ...
                                        <div class="form-group">
                                            <label for="invoice-detail-notes" class="text-heading">Ghi chú</label>
                                            <textarea class="form-control border-0 shadow-none form-control-lg" name="note" id="invoice-detail-notes"
                                                placeholder="Ghi chú - Ví dụ, &quot;Cảm ơn bạn đã hợp tác Kinh doanh với chúng tôi&quot;" style="height: 88px;"></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3">
                                <div class="card card-body mb-6 p-6">
                                            ...
                                            <div class="dropdown selectable-dropdown invoice-select-currency no-caret">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="currencyDropdown">
                                                    ...
                                                    <a class="dropdown-item d-flex"
                                                        ...
                                                        <div class="w-18px mr-1 image-flag">
                                                            <img src="{{ asset('assets/images/svg/flag-idr.svg') }}"
                                                                class="flag-width" alt="flag">
                                                        </div>
                                                    ...
                                                    <a class="dropdown-item d-flex"
                                                        ...
                                                        <div class="w-18px mr-1 image-flag">
                                                            <img src="{{ asset('assets/images/svg/flag-inr.svg') }}"
                                                                class="flag-width" alt="flag">
                                                        </div>
                                                    ...
                                                    <a class="dropdown-item d-flex"
                                                        ...
                                                        <div class="w-18px mr-1 image-flag">
                                                            <img src="{{ asset('assets/images/svg/flag-brl.svg') }}"
                                                                class="flag-width" alt="flag">
                                                        </div>
                                                    ...
                                                    <a class="dropdown-item d-flex"
                                                        ...
                                                        <div class="w-18px mr-1 image-flag">
                                                            <img src="{{ asset('assets/images/svg/flag-de.svg') }}"
                                                                class="flag-width" alt="flag">
                                                        </div>
                                                        <span class="selectable-text">
                                                            EUR -
                                                    ...
                                                    <a class="dropdown-item d-flex"
                                                        ...
                                                        <div class="w-18px mr-1 image-flag">
                                                            <img src="{{ asset('assets/images/svg/flag-try.svg') }}"
                                                                class="flag-width" alt="flag">
                                                        </div>
                                                        <span class="selectable-text">
                                                            TRY -
                                            ...
                                            <div class="form-group mb-0">
                                                ...
                                                <div class="dropdown selectable-dropdown invoice-tax-select no-caret">
                                                    <a id="typeDropdown"
                                                        ...
                                                        aria-expanded="false">
                                                        <span
                                                            class="selectable-text d-inline-block mr-auto text-truncate">Tổng
                                                            cộng</span>
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="typeDropdown">
                                                        ...
                                                        <a class="dropdown-item" data-value="5"
                                                            href="javascript:void(0);">Theo sản phẩm</a>
                                                        <a class="dropdown-item" data-value="25"
                                                            href="javascript:void(0);">Theo tổng cộng</a>
                                                        <a class="dropdown-item" data-value="0"
                                                            href="javascript:void(0);">Không có</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group mb-0 mt-3 tax-rate">
                                                <label for="rate1">Tỉ lệ (%)</label>
                                                <input type="number"
                                                    class="form-control border-0 shadow-none form-control-lg input-rate"
                                                    name="tax-rate" id="rate1" placeholder="Rate" value="25">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="invoice-action-discount mb-5">
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <div class="dropdown selectable-dropdown invoice-discount-select no-caret">
                                                <a id="discountDropdown"
                                                    ...
                                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    <span class="selectable-text d-inline-block mr-auto text-truncate">Số
                                                        tiền cố định</span>
                                                    <span><i class="fal fa-angle-down"></i></span>
                                                </a>
                                        ...
                                        <div class="form-group mb-0 mt-3 discount-amount">
                                ...
                                <div class="invoice-actions-btn card card-body p-6">
                                    <div class="invoice-action-btn">
                                        ...
                                        <div class="mb-3">
                                            <a href="{{ route('owners.invoice-preview') }}"
...
@push('styleOwners')
    ...
    <meta name="description"
        content="Xem trước hóa đơn chi tiết của bạn trên TRỌ NHANH. Kiểm tra thông tin thanh toán, các dịch vụ đi kèm, và số tiền cần thanh toán.">
    ...
    <meta name="twitter:title" content="Xem Trước Hóa Đơn - TRỌ NHANH">
    <meta name="twitter:description"
        content="Kiểm tra chi tiết hóa đơn của bạn bao gồm số tiền cần thanh toán, các dịch vụ đi kèm và lịch sử giao dịch.">
    <meta name="twitter:image" content="{{ asset('assets/images/tro-moi.png') }}">
    <!-- Facebook -->
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="Xem Trước Hóa Đơn - TRỌ NHANH">
