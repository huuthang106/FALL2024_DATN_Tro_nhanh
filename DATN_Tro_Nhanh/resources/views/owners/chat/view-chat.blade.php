...
@section('titleOwners', 'Chat | TRỌ NHANH')
@section('contentOwners')


    @livewire('contactList')
...
@push('styleOwners')
    ...
    <meta name="description"
        content="Trang Trò Chuyên trên TRỌ NHANH cung cấp thông tin chi tiết về các trò chơi và hoạt động đặc sắc. Khám phá các trò chơi, sự kiện và tin tức mới nhất trong cộng đồng.">
    ...
    <meta name="twitter:title" content="Trò Chuyên - TRỌ NHANH">
    <meta name="twitter:description"
        content="Khám phá các trò chơi và sự kiện đặc sắc trong cộng đồng Trò Chuyên trên TRỌ NHANH. Cập nhật tin tức mới nhất và tham gia vào các hoạt động hấp dẫn.">
    <meta name="twitter:image" content="{{ asset('assets/images/tro-moi.png') }}">
    <!-- Facebook -->
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="Trò Chuyên - TRỌ NHANH">
