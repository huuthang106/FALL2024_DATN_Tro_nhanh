    ...
    <main id="content">
                            ...
                            <div class="row mx-n2">
                                <div class="col-sm-6 col-md-4 col-lg-3 pt-4 px-2">
                                    <select class="form-control border-0 shadow-none form-control-lg selectpicker bg-white"
                                        name="status" title="Status" data-style="btn-lg py-2 h-52 bg-white">
        ...
        <section class="pt-6 pb-5 shadow-xs-1">
            <div class="container-fluid px-xxl-8">
                <form class="form-inline" id="accordion-5">
                    ...
                    <div id="advanced-search-filters-5" class="row pb-6 pt-2 collapse p-1" data-parent="#accordion-5">
                        <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label justify-content-start" for="check1-5">Điều hòa</label>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="features" id="check2-5">
                                <label class="custom-control-label justify-content-start" for="check2-5">Máy giặt</label>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="features" id="check4-5">
                                <label class="custom-control-label justify-content-start" for="check4-5">Máy giặt</label>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="features" id="check5-5">
                                <label class="custom-control-label justify-content-start" for="check5-5">Đồ nướng</label>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="features" id="check6-5">
                                <label class="custom-control-label justify-content-start" for="check6-5">Bãi cỏ</label>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="features" id="check7-5">
                                <label class="custom-control-label justify-content-start" for="check7-5">Xông hơi</label>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                            <div class="custom-control custom-checkbox">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label justify-content-start" for="check9-5">Máy sấy</label>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="features" id="check10-5">
                                <label class="custom-control-label justify-content-start" for="check10-5">lò vi
                                    sóng</label>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label justify-content-start" for="check11-5">Hồ bơi</label>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" name="features" id="check12-5">
                                <label class="custom-control-label justify-content-start" for="check12-5">Tấm che cửa
                                    sổ</label>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label justify-content-start" for="check14-5">Vòi sen ngoài
                                    trời</label>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label justify-content-start" for="check15-5">Cáp truyền hình
                                </label>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3 py-2">
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label justify-content-start" for="check16-5">Tủ lạnh</label>
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div id="compare" class="compare">
            ...
            <div class="list-group list-group-no-border bg-dark py-3">
                ...
                <div class="list-group-item card bg-transparent">
                    <div class="position-relative hover-change-image bg-hover-overlay">
                        <img src="{{ asset('asset/images/compare-02.jpg') }}" class="card-img" alt="properties">
                        <div class="card-img-overlay">
                            <a href="#"
                                class="text-white hover-image fs-16 lh-1 pos-fixed-top-right position-absolute m-2"><i
                                    class="fal fa-minus-circle"></i></a>
        ...
        <div class="d-none" id="template-properties">
            <div class="marker-item" data-icon-marker="{{ asset('assets/images/googlle-market-02.png') }}"
                ...
                <div class="card border-0">
                    <div class="position-relative hover-change-image bg-hover-overlay card-img-top"><img
                            src="{{ asset('assets/images/properties-grid-73.jpg') }}" alt="Home in Metric Way">
                        <div class="card-img-overlay d-flex flex-column">
                            <div><span class="badge badge-primary">For Sale</span></div>
                            <div class="mt-auto d-flex hover-image">
                                <ul class="list-inline mb-0 d-flex align-items-end mr-auto fs-14">
                                    <li class="list-inline-item mr-2"><a href="#"
                                            class="text-white hover-primary"><i class="far fa-images"></i><span
                                                class="pl-1">9</span></a></li>
                                    <li class="list-inline-item" title="2 Video"><a href="#"
                                            class="text-white hover-primary"><i class="far fa-play-circle"></i><span
                                                class="pl-1">2</span></a></li>
                                </ul>
                                <ul class="list-inline mb-0 mr-n3 d-flex">
                                    <li class="list-inline-item mr-3 h-32 d-flex align-items-end"><a href="#"
                                            class="text-white fs-20 hover-primary"><i class="far fa-heart"></i></a>
                                    </li>
                                    <li class="list-inline-item mr-3 h-32 d-flex align-items-end"><a href="#"
                    ...
                    <div class="card-body px-2 py-1">
                        <h2 class="fs-16 mb-1"><a href="single-property-1.html" class="text-dark hover-primary">Home
                                in Metric
                                Way</a>
                        </h2>
            ...
            <div class="marker-item" data-icon-marker="{{ asset('assets/images/googlle-market-02.png') }}"
                ...
                <div class="card border-0">
                    <div class="position-relative hover-change-image bg-hover-overlay card-img-top"><img
                            src="{{ asset('assets/images/properties-grid-69.jpg') }}" alt="Home in Metric Way">
                        <div class="card-img-overlay d-flex flex-column">
                            <div><span class="badge badge-primary">For Sale</span></div>
                            <div class="mt-auto d-flex hover-image">
                                <ul class="list-inline mb-0 d-flex align-items-end mr-auto fs-14">
            ...
            <div class="marker-item" data-icon-marker="{{ asset('assets/images/googlle-market-03.png') }}"
                ...
                <div class="card border-0">
                    <div class="position-relative hover-change-image bg-hover-overlay card-img-top"><img
                            src="{{ asset('assets/images/properties-grid-71.jpg') }}" alt="Home in Metric Way">
                        <div class="card-img-overlay d-flex flex-column">
                            <div><span class="badge badge-indigo">for Rent</span></div>
                            <div class="mt-auto d-flex hover-image">
                                <ul class="list-inline mb-0 d-flex align-items-end mr-auto fs-14">
            ...
            <div class="marker-item" data-icon-marker="{{ asset('assets/images/googlle-market-02.png') }}"
                ...
                <div class="card border-0">
                    <div class="position-relative hover-change-image bg-hover-overlay card-img-top"><img
                            src="{{ asset('assets/images/properties-grid-72.jpg') }}" alt="Home in Metric Way">
                        <div class="card-img-overlay d-flex flex-column">
                            <div><span class="badge badge-primary">For Sale</span></div>
                            <div class="mt-auto d-flex hover-image">
                                <ul class="list-inline mb-0 d-flex align-items-end mr-auto fs-14">
            ...
            <div class="marker-item" data-icon-marker="{{ asset('assets/images/googlle-market-02.png') }}"
                ...
                <div class="card border-0">
                    <div class="position-relative hover-change-image bg-hover-overlay card-img-top"><img
                            src="{{ asset('assets/images/properties-grid-70.jpg') }}" alt="Home in Metric Way">
                        <div class="card-img-overlay d-flex flex-column">
                            <div><span class="badge badge-primary">For Sale</span></div>
                            <div class="mt-auto d-flex hover-image">
                                <ul class="list-inline mb-0 d-flex align-items-end mr-auto fs-14">
            ...
            <div class="marker-item" data-icon-marker="{{ asset('assets/images/googlle-market-03.png') }}"
                ...
                <div class="card border-0">
                    <div class="position-relative hover-change-image bg-hover-overlay card-img-top"><img
                            src="{{ asset('assets/images/properties-grid-68.jpg') }}" alt="Home in Metric Way">
                        <div class="card-img-overlay d-flex flex-column">
                            <div><span class="badge badge-indigo">for Rent</span></div>
                            <div class="mt-auto d-flex hover-image">
                                <ul class="list-inline mb-0 d-flex align-items-end mr-auto fs-14">
...
@push('styleUs')
    ...
    <title>Listing Half Map Grid Layout 1 - HomeId</title>
    <!-- Google fonts -->
    <link
                            ...
                            <form class="form">
                                ...
                                <div class="d-flex p-2 border re-capchar align-items-center mb-4">
                                    ...
                                    <a href="#" class="d-inline-block ml-auto">
                                        <img src="{{ asset('asset/images/re-captcha.png') }}" alt="Re-capcha">
                                    </a>
                                </div>
