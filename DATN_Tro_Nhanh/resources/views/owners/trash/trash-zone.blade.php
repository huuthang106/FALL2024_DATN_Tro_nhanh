...
@push('styleOwners')
    ...
    <meta name="description"
        content="Quản lý các khu trọ đã bị xóa trong hệ thống. Xem lại và khôi phục các khu trọ đã bị đưa vào thùng rác.">
    ...
    <meta name="twitter:title" content="Thùng Rác Khu Trọ - TRỌ NHANH">
    <meta name="twitter:description" content="Xem và khôi phục các khu trọ đã bị xóa trong hệ thống TRỌ NHANH.">
    <meta name="twitter:image" content="{{ asset('assets/images/tro-moi.png') }}">

    <!-- Facebook -->
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="Thùng Rác Khu Trọ - TRỌ NHANH">
    <meta property="og:description"
        content="Quản lý các khu trọ đã bị xóa, khôi phục các khu trọ đã được đưa vào thùng rác trong hệ thống TRỌ NHANH.">
    <meta property="og:type" content="website">
